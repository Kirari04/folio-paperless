...
const AUTH_ERROR_KEYS: Readonly<Record<string, TranslationKey>> = {
  ...
  'headless-unavailable': 'profileError.oidcHeadlessUnavailable',
  'provider-not-configured': 'profileError.oidcProviderNotConfigured',
  'provider-token-unsupported': 'profileError.oidcProviderTokenUnsupported',
  'provider-token-rejected': 'profileError.oidcProviderTokenRejected',
  'additional-auth-required': 'profileError.oidcAdditionalAuth',
